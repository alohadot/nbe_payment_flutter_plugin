 ...
 *
 * How: on Android, OkHttp 4 writes its logs through the `java.util.logging` logger named
 * after `okhttp3.OkHttpClient` and forwards them to logcat (tag `okhttp.OkHttpClient`). OkHttp
...
internal object SdkNetworkLogSilencer {
    ...
    private const val OKHTTP_CLIENT_LOGGER = "okhttp3.OkHttpClient"
